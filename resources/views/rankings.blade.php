...
<main>
  ...
  <div class="flex flex-col gap-5 divide-y-2">
            ...
            @foreach($criterias as $column_key => $criteria)
              <tr>
                ...
                @foreach($criterias as $row_key => $criteria)
                  ...
                  <td class="bg-gray-100 border text-center px-8 py-4">0</td>
                  ...
                  @else
                  <td class="bg-gray-100 border text-center px-8 py-4">1</td>
                  @endif
                @endforeach
              </tr>
            @endforeach
    ...
    @if($criterias->isNotEmpty() && $alternatives->isNotEmpty())
      ...
      <div class="pt-3">
        <button type="button" class="w-full px-2 py-1 bg-green-500 font-bold text-white rounded-md">Mulai Proses Perankingan</button>
      </div>
    @endif
